...
// ── Hero Animated Statements ──────────────────────────────────
export const REPO_STATEMENTS = [
  {
    id: 'flyrank',
    from: 'manual SEO & tedious organic outreach',
    to: 'an autonomous AI growth autopilot',
    benefit: 'exponential organic customer acquisition.',
    project: 'FlyRank AI',
    tag: 'AI Engineering',
    color: '#f59e0b',
    bgLight: 'rgba(245, 158, 11, 0.12)',
    borderColor: 'rgba(245, 158, 11, 0.35)',
    demo: 'https://www.linkedin.com/posts/ca%C3%B1ada-aaron-m-352572352_flyrank-is-building-the-autopilot-for-organic-activity-7470102063142588416-0XyC',
    metric: 'AI-First Growth',
  },
  {
    id: 'syncstudy',
    from: 'scattered notes & endless browser tabs',
    to: 'a real-time AI study workspace',
    benefit: 'seamless team collaboration & focus.',
    project: 'SyncStudy',
    tag: 'Full-Stack',
    color: '#3b82f6',
    ...
    demo: 'https://sync-study-ten.vercel.app/',
    metric: 'Live Rooms + AI Bot',
  },
  {
    id: 'schatzies',
    from: 'just a Facebook page with low trust',
    to: 'a high-converting premium booking platform',
    benefit: 'tripled inbound client inquiries.',
    ...
    demo: 'https://www.schatziesevents.com/',
    metric: 'Production Client',
  },
  {
    id: 'algo',
    from: 'abstract data structures & dry theory',
    to: 'an interactive macOS-inspired playground',
    benefit: 'instant visual comprehension.',
    ...
    demo: 'https://aaron-compilation-portfolio.vercel.app/',
    metric: 'Interactive Demos',
  },
  {
    id: 'lingualink',
    from: 'real-world language & barrier friction',
    to: 'a smart Flutter + Firebase mobile app',
    benefit: 'instant live camera OCR translation.',
    project: 'LinguaLink',
    tag: 'Mobile & AI',
    color: '#06b6d4',
    bgLight: 'rgba(6, 182, 212, 0.12)',
    borderColor: 'rgba(6, 182, 212, 0.35)',
    demo: 'https://github.com/Uryegedon/smarttranslate',
    metric: 'Trie & Levenshtein',
  },
  {
    id: 'lifesync',
    from: 'chaotic task lists & fragmented expenses',
    to: 'a secure all-in-one productivity hub',
    benefit: 'crystal-clear daily execution.',
