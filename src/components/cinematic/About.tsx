...
const About = () => {
  ...
  // ← Edit stats in src/data/portfolio.ts → STATS
  const stats = STATS.map((s, i) => ({ ...s, delay: 100 + i * 120 }));

  // ← Edit tech pills in src/data/portfolio.ts → TECH_PILLS
  const techs = TECH_PILLS;
      ...
      <div className="max-w-6xl mx-auto px-6">
        ...
        <div className="grid lg:grid-cols-[auto_1fr_1fr] gap-12 lg:gap-16 items-start">
          ...
          >
            ...
            {/* ← Edit bio paragraphs in src/data/portfolio.ts → PERSONAL.bio */}
            {PERSONAL.bio.map((text, i) => (
              <p
                key={i}
