    ...
    <section id="contact" className="py-24 border-t border-neutral-200 dark:border-neutral-800 relative overflow-hidden">
      ...
      <div className="max-w-6xl mx-auto px-6">
        ...
        <div ref={contentRef as React.RefObject<HTMLDivElement>} className="grid lg:grid-cols-2 gap-16 items-start">
          ...
          <div>
            ...
            >
              ...
              >
                ...
                <span className="relative z-10 text-sm sm:text-base">canada.aaron.mulat@gmail.com</span>
          ...
          >
            {[
              { icon: Github, label: 'GitHub', value: '@EYRON27', href: 'https://github.com/EYRON27', color: '#f59e0b', delay: 250 },
              { icon: Linkedin, label: 'LinkedIn', value: 'Aaron Cañada', href: 'https://www.linkedin.com/in/ca%C3%B1ada-aaron-m-352572352/', color: '#0ea5e9', delay: 350 },
              { icon: MapPin, label: 'Location', value: 'Quezon City, Philippines', href: '#', color: '#10b981', delay: 450 },
            ].map((link) => (
              <div
                key={link.label}
